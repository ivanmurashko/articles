...
relationship with other LLVM components. We will start with the overall compiler
architecture overview. One of our main topics will be the clang driver -
