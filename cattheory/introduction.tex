...
\mynameref{def:category}), \mynameref{def:functor}s,
\mynameref{def:nt}, \mynameref{def:monad}s and finish with important
results from the category theory such as Yoneda lemma and
