...
\cat{D}$ and another one $J,K: \cat{D} \to \cat{E}$. If we have a
...
\mynameref{def:functor}s $F,G: \cat{C} \to \cat{D}$, $H: \cat{D} \to
...
\mynameref{def:functor}s $F,G: \cat{C} \to \cat{D}$, $H: \cat{B} \to
