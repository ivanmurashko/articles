...
\begin{figure}
  ...
  \end{tikzpicture}
  \caption{Natural transformation composition: object mapping}
...
\begin{figure}
  ...
  \begin{tikzpicture}[ele/.style={fill=black,circle,minimum
    ...
    \draw[->,thick,shorten <=2pt,shorten >=2pt] (bf) to
     ...
     (bh); 
  \end{tikzpicture}
  \caption{Natural transformation composition: morphism mapping -
    commutative diagram}
...
\cref{fig:nt_morphism_mapping_composition}) commutes.   
...
\[
\alpha \circ \beta: FJ \xrightarrow{.} GK
\] 
