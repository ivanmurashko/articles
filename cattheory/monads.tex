...
the required element. Lets $I \in \cathom{C}$ and $U =
\eta\left(I\right)$. We want to show that 
\begin{equation}
U \otimes M \cong M \otimes U \cong M, 
\nonumber
\end{equation}
...
\eqref{eq:monad_p1} on $M \circ I$:
\begin{eqnarray}
\mu \circ \left( \idnt{M} \star \eta \right) \left[M \circ I\right] = 
\nonumber \\
=
...
\eqref{eq:monad_p1}
\begin{eqnarray}
\mu \circ \left( \eta \star \idnt{M} \right) \left[I \circ M\right] = 
\nonumber \\
=
\mu \left[U \circ M\right] = U \otimes M.
\nonumber
\end{eqnarray}
We assume that $M \circ I \cong M$ and $I \circ M \cong M$  thus
finally
\[
M \otimes U \cong U \otimes M \cong M
\]
