...
\begin{definition}[Domain]
  ...
  \mynameref{def:object} $a$ is called domain and is denoted as $\dom f$.
\end{definition}

\begin{definition}[Codomain]
  \label{def:codomain}
  Given a \mynameref{def:morphism} $f: a \to b$, the
  \mynameref{def:object} $b$ is called codomain and is denoted as $\cod f$.
\end{definition}
...
\begin{example}[\textbf{Set} category]
  ...
  \index{Category!\textbf{Set} example}
