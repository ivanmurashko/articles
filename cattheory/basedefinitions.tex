...
\begin{example}[\textbf{FdHilb} category]
  ...
  all finite dimensional Hilbert spaces as a category. The category is
  denoted as \textbf{FdHilb}. It is very similar to
  \mynameref{ex:relcategory}. The brief relation is describe in the
  \cref{tab:rel_vs_fdhilb}
 
  \begin{table}
    \centering
    \caption{Relations between \textbf{Set}, \textbf{Rel} and \textbf{FdHilb} categories}
    \label{tab:rel_vs_fdhilb}
    \begin{tabular}{l|l|l|l}
      ...
      linear operator in Hilber space\\
      \bottomrule
    \end{tabular}
  \end{table}
