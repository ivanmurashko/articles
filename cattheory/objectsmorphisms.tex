...
The \mynameref{def:product} in \mynameref{ex:fdhilbcategory} is a
tensor product of 2 \mynameref{def:hilber_space}s i.e. if
$\mathcal{A}$ and $\mathcal{B}$ are two Hilber spaces then the product
is the tensor product of the spaces: $\mathcal{A} \otimes
\mathcal{B}$.

Note that the tensor product in quantum mechanics is used for
