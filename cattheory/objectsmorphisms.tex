...
The $\cat{Proof}$ category is a category where statements are
\mynameref{def:object}s and proofs are \mynameref{def:morphism}s
\end{definition}
...
\begin{table}
  ...
  \begin{adjustbox}{width=1\textwidth}
    ...
    \begin{tabular}{l|l|l}
      ...
      \midrule
      \mynameref{def:proposition} & Type & \mynameref{def:object} \\
