...
\end{figure}
You can see that the probability to get red ball is $P(R) =
\frac{5}{6}$, blue one is $P(B) = \frac{3}{6}$, green one is $P(G) =
\frac{4}{6}$. 
...
\begin{figure}
  ...
  \end{tikzpicture} 
  \caption{Condition probability. $P(R|B) = \frac{2}{3}$, $P(G|B) =
    \frac{1}{3}$} 
...
\begin{figure}
  ...
  \end{tikzpicture}
  \caption{Condition probability. $P(B|G) = \frac{1}{4}$, $P(R|G) =
    \frac{3}{4}$} 
